    ...
    <article class="hotel-card ${hasData ? "" : "hotel-card-empty"}">
      <div class="hotel-card-header">
        <div>
          ...
          <small>${hasData ? `${integer.format(hotel.opinions || 0)} ${hotel.opinions === 1 ? "opinário" : "opiniários"} | ${integer.format(hotel.answeredItems || 0)} itens avaliados` : `Sem opiniários no ${state.periodMode === "day" ? "dia" : "período"}`}</small>
        </div>
